<?php
namespace AwkwardIdeas\MyPDO;

use AwkwardIdeas\MyPDO\DBConnection as Connection;
use AwkwardIdeas\MyPDO\SQLParameter as Parameter;
...
class DB{
    ...
    public function EstablishConnections($host, $dbname, $rUser, $rPwd, $rwUser, $rwPwd){
        try {
            ...
            self::$dbConnection = new Connection($mysqlReader, $mysqlAdmin);
